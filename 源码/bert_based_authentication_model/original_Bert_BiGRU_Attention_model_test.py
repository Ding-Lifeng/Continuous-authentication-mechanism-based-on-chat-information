...
"""
# File       : original_Bert_BiGRU_Attention_model_test.py
# Time       ：2025/3/13 上午9:04
# Author     ：丁笠峰
# version    ：python 3.9
# note       ：使用没有微调的Bert+BiGRU+Attention模型结构绘制ROC曲线，计算AUC值和最佳分类阈值，观察模型的分类效果，和微调后的分类效果比较
"""
