...
"""
# File       : bert_BiGRU_model_test.py
# Time       ：2025/2/27 下午8:23
# Author     ：丁笠峰
# version    ：python 3.9
# note       ：使用Bert+BiGRU+softmax模型结构开展测试
"""
...
if __name__ == "__main__":
    ...
    # 加载模型参数
    # model_load_path = '..//..//model//fine-tuning//fine-tuning-bert-BiGRU-1.pt'
    model_load_path = '..//..//model//fine-tuning//fine-tuning-bert-BiGRU-convergence-1.pt'
