...
"""
# File       : bert_BiGRU_Attention_A-softmax_model_test.py
# Time       ：2025/1/6 下午9:14
# Author     ：丁笠峰
# version    ：python 3.9
# note       ：使用Bert+BiGRU+Attention+A-softmax模型结构开展测试
"""
...
if __name__ == "__main__":
    ...
    # 加载模型参数
    # model_load_path = '..//..//model//fine-tuning//fine-tuning-bert-BiGRU-ATT-ASoftmax-1.pt'
    model_load_path = '..//..//model//fine-tuning//fine-tuning-bert-BiGRU-ATT-ASoftmax-convergence-1.pt'
