...
"""
# File       : fine_tuning_Bert_BiLSTM_Attention_with_samples.py
# Time       ：2025/2/27 下午10:16
# Author     ：丁笠峰
# version    ：python 3.9
# note       ：使用训练集微调组合模型(Bert-BiLSTM-Attention)
"""
...
if __name__ == "__main__":
    ...
    # 保存微调后的模型
    # model_save_path = '..//..//model//fine-tuning//fine-tuning-bert-BiLSTM-ATT-1.pt'
    model_save_path = '..//..//model//fine-tuning//fine-tuning-bert-BiLSTM-ATT-convergence-1.pt'
