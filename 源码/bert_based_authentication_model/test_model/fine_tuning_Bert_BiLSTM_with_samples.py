...
"""
# File       : fine_tuning_Bert_BiLSTM_with_samples.py
# Time       ：2025/2/27 下午10:15
# Author     ：丁笠峰
# version    ：python 3.9
# note       ：使用训练集微调组合模型(Bert-BiLSTM)
"""
...
class BertBiLSTMModel(nn.Module):
    ...
    def forward(self, input_ids, attention_mask):
        ...
        # 取LSTM输出的最后一个时间步的隐藏状态（序列的综合信息）作为输入
...
if __name__ == "__main__":
    ...
    # 保存微调后的模型
    # model_save_path = '..//..//model//fine-tuning//fine-tuning-bert-BiLSTM-1.pt'
    model_save_path = '..//..//model//fine-tuning//fine-tuning-bert-BiLSTM-convergence-1.pt'
