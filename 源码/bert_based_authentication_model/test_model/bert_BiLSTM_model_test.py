...
"""
# File       : bert_BiLSTM_model_test.py
# Time       ：2025/2/27 下午9:58
# Author     ：丁笠峰
# version    ：python 3.9
# note       ：使用Bert+BiLSTM+softmax模型结构开展测试
"""
...
if __name__ == "__main__":
    ...
    # 加载模型参数
    # model_load_path = '..//..//model//fine-tuning//fine-tuning-bert-BiLSTM-1.pt'
    model_load_path = '..//..//model//fine-tuning//fine-tuning-bert-BiLSTM-convergence-1.pt'
