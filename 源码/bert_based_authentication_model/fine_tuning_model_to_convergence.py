...
"""
# File       : fine_tuning_model_to_convergence.py
# Time       ：2025/4/15 下午11:17
# Author     ：丁笠峰
# version    ：python 3.9
# note       ：修改训练集构造代码，使用训练集微调组合模型(Bert-BiGRU-Attention)至收敛
"""
...
if __name__ == "__main__":
    ...
    # 保存微调后的模型
    model_save_path = '..//model//fine-tuning//fine-tuning-bert-BiGRU-ATT-convergence-1.pt'
